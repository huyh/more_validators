...
describe "Validators" do
  ...
  describe MoreValidators::JsonValidator do
    let(:validator) { MoreValidators::JsonValidator.new({:attributes => attribute}) }
    ...
    it "can use a specified error message" do
      validator = MoreValidators::JsonValidator.new({:attributes => attribute, :message => 'hello world error'}) 
      validator.validate_each(model, attribute, 'hello')
      subject.should == ['hello world error']
    end
  end

  describe MoreValidators::EmailValidator do
    let(:validator) { MoreValidators::EmailValidator.new({:attributes => attribute}) }
